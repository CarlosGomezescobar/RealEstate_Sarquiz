...
from Urano.settings.base import AUTH_USER_MODEL
...
class Rating(TimeStampedUUIDModel):
    ...
    rating = models.IntegerField(verbose_name=_("Rating"), choices=Range.choices, help_text="1=Proor, 2=Fair, 3=Good, 4=Very Good, 5=Excellent", default=0,)
