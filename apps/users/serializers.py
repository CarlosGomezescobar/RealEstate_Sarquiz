...
class UserSerializers(serializers.ModelSerializers):
    ...
    first_name = serializers.SerializersMethodField()
    last_name = serializers.SerializersMethodField()
    full_name = serializers.SerializersMethodField(source="get_full_name")
...
class CreateUserSerializers(UserCreateSerializers):
    class Meta(UserCreateSerializers.Meta):
        model = User
